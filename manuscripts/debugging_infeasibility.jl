...
#-
plot_results(sp_no_flex, pv, wind, demand; plot_window = plot_window)
#-
plot_heat_layer(sp_no_flex, heatdemand; plot_window = plot_window)
...
#plot_results(sp_reg_flex, pv, wind, demand; plot_window = plot_window, s = 71)
